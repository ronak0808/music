...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="login_as_artist.css">
     ...
     <div class="box">
      <div class="form-container">
         <div class="form-btn">
             ...
             <form method="POST" action="login_as_artist .php">
...
<!---footer-->
 <div class="footer">
  <div class="container">
    ...
    <p class="Copyright">Copyright 2023-musify</p>
 ...
 if(isset($_POST['login_Btn']))
{
  ...
  $sql="SELECT * FROM  websitelogin.login_artist WHERE username='$username'";
  ...
  while($row=mysqli_fetch_assoc($result))
  {
    ...
    {
      header('Location:music player hackthon/artist.html');
    }else{
